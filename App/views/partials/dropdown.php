...
<form method="GET" action="/listings/search" class="flex flex-col space-y-4 bg-white p-4 shadow-lg rounded-lg w-1/3">
  <div>
    <label for="category" class="block text-sm font-medium text-gray-700">Chọn danh mục:</label>
    <select name="category" id="category" class="mt-1 block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-base text-gray-700 focus:border-indigo-500 focus:ring-indigo-500">
      <option value="0">Tất cả</option>
      <option value="1">Đồ điện tử</option>
      <option value="2">Thời trang</option>
      <option value="3">Gia dụng</option>
  ...
  <button type="submit" class="w-full inline-flex justify-center items-center rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
