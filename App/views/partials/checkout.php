...
if (Session::has('cart') && is_array(Session::get('cart'))) {
    foreach ($_SESSION['cart'] as $cart) {
        $subbtotal += $cart['total'] * $cart['quantity'];
    }
}
                ...
                <div class="mt-10 lg:mt-0">
                    ...
                    <div class="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
                        ...
                        <ul role="list" class="divide-y divide-gray-200">
                            <?php if (Session::has('cart') && is_array(Session::get('cart'))) : ?>
                                    ...
                                    <li class="flex px-4 py-6 sm:px-6">
                                        ...
                                        <div class="ml-6 flex flex-1 flex-col">
                                            ...
                                            <div class="flex flex-1 items-end justify-between pt-2">
                                                ...
                                                <form method="post" action="/update_cart" class="ml-4">
                                                    ...
                                                    <button type="submit" class="ml-4 text-sm font-medium text-indigo-600 hover:text-indigo-500">Update</button>
